...
// const { gitHubLogin } = useContext(AuthContex)
      ...
      <div className="w-full  max-w-md p-4 rounded-md  border sm:p-8 dark:bg-gray-50 dark:text-gray-800">
        ...
        <div className="my-6 space-y-4">
          ...
          {/* <button
            ...
            aria-label="Login with GitHub" role="button" className="btn flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
